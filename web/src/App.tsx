...
import { KeyAuthFilesPage } from './pages/KeyAuthFilesPage';
  ...
  if (authState === 'checking') {
    ...
    page = keyViewerPath === '/key-analysis'
      ...
      : keyViewerPath === '/key-events'
        ...
        : keyViewerPath === '/key-auth-files'
          ? <KeyAuthFilesPage apiKey={sessionAPIKey} onNavigate={handleKeyViewerNavigate} onAuthRequired={clearSession} />
